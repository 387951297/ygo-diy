<template>
  ...
  >
    ...
    <card-text
      ...
      :def-str="defStr"
      :card-type="cardType"
      :content-html="contentHtmlFormate"
    ></card-text>
    <!-- 卡片id -->
    <card-id
...
import CardRightAttribute from "./CardRightAttribute";
import CardInnerImg from "./CardInnerImg";
  ...
  watch: {
    cardType(value) {
      switch (value) {
        case "magic":
        case "trap":
          this.showRightAttribute = true;
          this.showStar = false;
          break;
        default:
          this.showRightAttribute = false;
          this.showStar = true;
          break;
      }
    },
